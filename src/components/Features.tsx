            ...
            <div key={group.label}>
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {group.items.map((mod) => (
                  <div
                    key={mod.title}
                    className="group rounded-2xl border border-asphalt-200 p-6 transition hover:border-signal-500/50 hover:shadow-lg hover:shadow-asphalt-950/5 dark:border-asphalt-800"
                  >
